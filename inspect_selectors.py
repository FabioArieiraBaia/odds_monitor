...
async def main():
    ...
    async with async_playwright() as pw:
        try:
            ...
            # Inspecionar elementos com texto "Ao-Vivo" ou similares
            elements_info = await page.evaluate("""
                () => {
                    ...
                    allEls.forEach(el => {
                        ...
                        if (text === 'Ao-Vivo' || text === 'Ao Vivo') {
                            // Get class list and parent tag/classes
            ...
            print(f"\nEncontrados {len(elements_info)} elementos com texto exato 'Ao-Vivo' ou 'Ao Vivo':")
