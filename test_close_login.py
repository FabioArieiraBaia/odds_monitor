...
async def main():
    ...
    async with async_playwright() as pw:
        try:
            ...
            # Clicar no botão 'Ao-Vivo' da TabBar
            ...
            # Verificar se o modal de login apareceu e pressionar Escape
            print("Pressionando Escape para fechar qualquer modal de login...")
            ...
            # Tirar screenshot
            screenshot_path = os.path.join(ARTIFACT_DIR, "tab_ao_vivo_dismissed.png")
